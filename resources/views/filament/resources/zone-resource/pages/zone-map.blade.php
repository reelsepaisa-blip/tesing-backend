{{-- Zone Map View (map hidden, other styles unchanged) --}}
<x-filament::page>
    <div class="space-y-4">
        <!-- Zone Header -->
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-2">
                <span @class([
                    ...
                    'bg-green-100 text-green-800' => $record->status,
        ...
        <!-- Interactive Google Maps (hidden) -->
        <div class="hidden" aria-hidden="true">
            <div class="w-full h-[600px] rounded-xl border border-gray-200 shadow-sm bg-gray-50 flex items-center justify-center text-gray-500">
                Map (hidden)
            </div>
        </div>
            ...
            <x-filament::card>
                <div class="text-sm">
                    ...
                    <div class="mt-1 text-2xl font-bold text-gray-900">
                        {{ number_format(\App\Models\Booking::where('status', 'completed')->where('pickup_zone_id', $record->id)->avg('waiting_time') ?? 0, 1) }}
                        min
                    </div>
                </div>
            </x-filament::card>
