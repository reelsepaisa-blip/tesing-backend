<div class="space-y-4">
    @foreach($wallet->transactions()->latest()->limit(5)->get() as $transaction)
    ...
    @if($wallet->transactions()->count() > 5)
        <div class="mt-4 text-center">
            <a href="{{ route('filament.admin.resources.wallet-transactions.index', ['wallet' => $wallet->id]) }}" class="text-sm text-primary-600 hover:text-primary-500">
