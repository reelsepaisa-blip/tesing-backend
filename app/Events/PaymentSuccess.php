...
class PaymentSuccess implements ShouldBroadcastNow
{
    ...
    public function broadcastWith(): array
    {
        ...
        $paymentMethod = strtolower($this->transaction->payment_method ?? '');
        ...
        $broadcastData = [
            ...
            'payment_method' => (string) ($this->transaction->payment_method ?? ''),
        ];
    ...
    private function generateInvoice($booking): array
    {
        ...
        return [
            ...
            'driver' => [
                ...
                'vehicle' => $vehicle ? ($vehicle->model ?? 'Unknown') : 'Unknown',
            ...
            'payment_details' => [
                ...
                'is_split_payment' => ((float) ($booking->wallet_amount ?? 0) > 0 && (float) ($booking->online_paid_amount ?? 0) > 0),
            ],
        ];
    }
